package kberestbrewery.bootstrap;
...
/* la anotación @Slf4j simplifica el uso de loggers en Java
mediante la generación automática de un campo Logger en una
clase. Al utilizar @Slf4j, no es necesario declarar
manualmente un campo Logger y se pueden registrar mensajes
en el código de forma más sencilla utilizando los métodos
proporcionados por la interfaz Logger.*/
...
public class BeerLoader implements CommandLineRunner {
    ...
    /*synchronized se utiliza para lograr sincronización en
    hilos concurrentes y evitar problemas de concurrencia*/
